...
PKG = 'Liquirizia.DataAccessObject.Implements.AWS.OpenSearch'
SRC = 'src'
EXCLUDES = []
DESC = 'AWS OpenSearch Data Access Object for Liquirizia',
WHO = 'Heo Yongseon'
...
setup(
	...
	classifiers=[
		...
		'Liquirizia',
		'Liquirizia :: DataAccessObject :: AWS :: OpenSearch',
	],
	install_requires=[
